...
public class HttpPointApplication implements ApplicationListener<ContextClosedEvent> {

  @Autowired private SimulatorOpts opts;

  private ActivitySimulator simulator;

  public static void main(String[] args) {
    SpringApplication.run(HttpPointApplication.class, args);
  }
  ...
  public @ResponseBody String setSkikeMode(@PathVariable("mode") String mode) {
